...
result = subprocess.run("ls /scratch/sbidadi/ai4wind/raft/deepcwind/OC6semi_cases >> list_of_cases.dat", shell=True, capture_output=True, text=True)
...
with open("list_of_cases.dat", "r") as file:
 ...
 #       print(line.split('_')[2], line.split('_')[4], line.split('_')[6], line.split('_')[8], line.split('_')[10], (line.split('_')[12]).split('.yaml')[0] )
        ...
        with open('/scratch/sbidadi/ai4wind/raft/deepcwind/OC6semi_cases/'+line.strip()) as file:
...
#with open('output_OC6_wamit.txt', 'w') as f:
#
#     for j, wave_params_and_forces_per_wave in enumerate(all_forces):
#
